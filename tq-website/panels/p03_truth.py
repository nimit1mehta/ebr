  ...
  <div class="nv-container">
    ...
    <div class="nv-truthgrid">
      <div class="nv-halfcard nv-halfcard-origin">
        <h3 class="nv-h3">Ground truth</h3>
...
.nv-truth-sec{position:relative;padding:76px 0}

.nv-truthgrid{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);
  gap:44px;margin-top:28px;align-items:stretch}
...
.nv-halfcard{border:1px solid var(--nv-line);background:#fff;padding:26px;height:100%}
...
.nv-illus{font-family:var(--nv-mono);font-size:9px;font-weight:600;letter-spacing:.12em;
  ...
  padding:3px 7px}
.nv-figure{padding:16px 0;border-top:1px solid var(--nv-line)}
.nv-figure:last-child{padding-bottom:0}
.nv-figure-top{display:flex;align-items:baseline;gap:10px}
.nv-figure-arrow{font-size:9px;line-height:1;color:var(--nv-accent)}
.nv-figure[data-dir="down"] .nv-figure-arrow{color:#1f9d55}
.nv-figure-value{font-family:var(--nv-display);font-size:clamp(1.3rem,1.9vw,1.6rem);
  font-weight:700;letter-spacing:-.015em;color:var(--nv-ink);line-height:1}
...
.nv-figure-note{font-family:var(--nv-body);font-size:.88rem;line-height:1.5;
  color:var(--nv-muted);margin:7px 0 0;max-width:46ch}
